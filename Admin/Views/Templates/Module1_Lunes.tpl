...
<div class="Container thirteen wide column ContainerLayout">
    <div class="ui segment">
        ...
        <iframe src='http://10.0.3.10/BBINCOTV/IPTV/content.php?MacAddress=00:00:00:00:00:00&ModuleId=3&CurrentModule=Realestate' style='width:384px;height:216px; margin: 2%;'></iframe>
...
$("#FormUploadAjax").on("submit", function(e){
    ...
    $.ajax({
        url: "../Querys/Module1_Lunes.php?Option=UploadMultimedia",
        type: "post",
        dataType: "json",
        data: formData,
        cache: false,
...
$('#Delete').click(function(){
    $.ajax({
        url: "../Querys/Module1_Lunes.php?Option=DeleteMultimedia",
        type: "post",
        dataType: "json",
