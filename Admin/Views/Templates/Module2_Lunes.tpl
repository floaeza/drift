...
<div class="Container thirteen wide column ContainerLayout">
    <div class="ui segment">
        ...
        <img id="LOADING" src="http://10.0.3.10/BBINCOTV_V/1.0.0/Admin/Media/spinner_blue.gif" style="position: fixed;z-index: 1;width: 6%;bottom: 7%;right: 0; display: none;">
        <h3 id='TEXTLOADING' style="position: fixed;z-index: 1;width: 40%;bottom: 0;right: 0; display: none;text-align: right;">Subiendo video, espere mientras se carga</h3>
        <div class="TabsS">
            <div>
                <div id="Tab1">
        ...
        <div style='color: #2185d0; margin: 1%; font-size: 23px;'>Vista preliminar:<div/>
        <iframe src='http://10.0.3.10/BBINCOTV/IPTV/content.php?MacAddress=00:00:00:00:00:00&ModuleId=4&CurrentModule=Homeowners' style='width:384px;height:216px; margin: 2%;'></iframe>
...
$("#FormUploadAjax").on("submit", function(e){
    ...
    $.ajax({
        url: "../Querys/Module2_Lunes.php?Option=UploadMultimedia",
        type: "post",
        dataType: "json",
        data: formData,
        cache: false,
...
$('#Delete').click(function(){
    $.ajax({
        url: "../Querys/Module2_Lunes.php?Option=DeleteMultimedia",
        type: "post",
        dataType: "json",
