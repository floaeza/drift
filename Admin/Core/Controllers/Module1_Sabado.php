...
if(isset($_SESSION['UserId'])){
    ...
    $ProfileName = $_SESSION['ProfileName'];
        ...
        $ImagesList="";
        $id = 0;
        $filehandle = opendir('/var/www/html/MULTIMEDIA_VDM/Module1/Saturday/'); // Abrir archivos
...
//                $id++;
        ...
        foreach ($list as $fileName) {
            $ImagesList.= '<img id="'.$id.'" style="max-height:90px;" class="ui image" src="/MULTIMEDIA_VDM/Module1/Saturday/'.$fileName.'" tabindex="1" onclick="Selection();" title="'.$fileName.'">';
            $id++;   
        }        
        $Content = new Templates($Directory.'/Views/Templates/Module1_Sabado.tpl');
