 ...
 *******************************************************************************/
    ...
    var PanelLeftTop        = document.getElementById('PanelLeftTop'),
        ...
        PanelRightTop          = document.getElementById('PanelRightTop'),
        PanelRightTopId        = 'PanelRightTop',
        PanelRightBottom          = document.getElementById('PanelRightBottom'),
        PanelRightBottomId        = 'PanelRightBottom',
        SliderInterval1     = '',
        SliderInterval2     = '',
        SliderInterval3     = '',
        SliderInterval4     = '',
       ...
       $.ajax({
            ...
            success: function (response){
                ...
                for(Index = 0; Index < TemplateList.length; Index++){
                    ...
                    } else if(TemplateList[Index].seccion === 'PanelRightTop'){
                        PanelRightTopId = Index;
                    } else if(TemplateList[Index].seccion === 'PanelRightBottom'){
                        PanelRightBottomId = Index;
                    }
                }
...
        if(RightTopContentLength > 0){
            ...
            PanelRightTop.src = MediaSource + TemplateList[PanelRightTopId][Content][Index3];
...
    }
    ...
    function SetSlider3(){
        ...
        IntervalRightTop = parseInt(TemplateList[PanelRightTopId].tiempo_pantalla,10) * 1000;
        SliderInterval3 = setInterval(Slider3,IntervalRightTop);

        /* Obtiene la longitud del contenido */
        RightTopContentLength = TemplateList[PanelRightTopId][Content].length;
...
        if(RightBottomContentLength > 0){
            ...
            PanelRightBottom.src = MediaSource + TemplateList[PanelRightBottomId][Content][Index4];
...
    }
    ...
    function SetSlider4(){
        ...
        IntervalRightBottom = parseInt(TemplateList[PanelRightBottomId].tiempo_pantalla,10) * 1000;
        SliderInterval4 = setInterval(Slider4,IntervalRightBottom);

        /* Obtiene la longitud del contenido */
        RightBottomContentLength = TemplateList[PanelRightBottomId][Content].length;
