...
cred = credentials.Certificate('/var/www/html/BBINCO/bbincotv/Views/Scripts/FireBase/serviceAccountKey.json')
...
#Identifier = requests.post('http://bbinco.fortiddns.com:669/BBINCO/bbincotv/Core/Controllers/PY.php', data=payload)
...
for i in range(1,100):
    try:
        with open('/var/www/html/BBINCO/bbincotv/Core/Controllers/Epg/'+identificador+'/epg_'+fechajson+'_'+str(i)+'.json') as file:
    ...
    for change in changes:
        if change.type.name == 'ADDED':
            ...
            if stb['status'] == 'pending':
                ...
                var = requests.post('http://localhost/BBINCO/bbincotv/Core/Controllers/Firebase.php', data=payload)
                #requests.post('http://bbinco.fortiddns.com:669/BBINCO/bbincotv/Core/Controllers/Firebase.php', data=payload)
