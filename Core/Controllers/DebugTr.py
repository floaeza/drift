...
if cadena == '2':
    ...
    pak = requests.post('http://172.22.22.10/BBINCO/TV/Core/Controllers/PY.php', data=payload)
    ...
    for pos in range(len(listDays)):
        ...
        req = requests.post('http://172.22.22.10/BBINCO/TV/Core/Controllers/Packages.php', data=info)
